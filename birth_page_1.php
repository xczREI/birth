	<style>
		...
		// Save new religious sect ONLY on Enter
		$('#mother_sect, #father_sect').on('keydown', function(e){
			if (e.key === "Enter") {
				var val = $(this).val();
				var exists = false;
		...
		// Save new occupation ONLY on Enter
		$('#mother_occupation, #father_occupation').on('keydown', function(e){
			if (e.key === "Enter") {
				var val = $(this).val();
				var exists = false;
		...
		// Save new citizenship ONLY on Enter
		$('#mother_citizen, #father_citizen').on('keydown', function(e){
			if (e.key === "Enter") {
				var val = $(this).val();
				var exists = false;
		...
		<script>
			...
			document.getElementById("father_country").addEventListener("focus", function() {
				if(this.value === "PHILIPPINES") {
					this.value = "";
				}
			});
