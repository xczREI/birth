          ...
          <div class="modal-body" id="modal1A">
            <div class="form_1A" style="padding:0 30px 0 20px; width:800px;margin: auto;">
              ...
              <div style="width:30%;float:right;">
                <input type="text" class="form-control form-control-sm" name="date_now" style="border-bottom: 1px solid black; border-radius:0; text-transform:uppercase;" value="<?php echo date('F j, Y', strtotime('now')); ?>">
              ...
              Date Paid &emsp;&emsp;&nbsp; :
              <div class="custom-control custom-checkbox custom-control-inline mt-1" style="width:20%;padding-left:0;margin-right:0;">
                <input type="text" class="form-control form-control-sm" name="date_paid" style="border-bottom: 1px solid black; border-radius:0;" value="<?php echo date('F j, Y', strtotime('now')); ?>">
              </div><br>
              </h6>
